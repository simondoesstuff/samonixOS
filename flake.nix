{
  ...
  outputs = {...} @ inputs: rec {
    ...
    packages.x86_64-linux.homeConfigurations.activationPackage = {
      "mason@wsl" = nixosConfigurations.wslOnix.config.home-manager.users."mason".home.activationPackage;
      "mason@xps" = nixosConfigurations.xpsOnix.config.home-manager.users."mason".home.activationPackage;
    };
